...
Upload a file from Amazon S3 팝업이 보여지면, Amazon S3 link URL에 ```https://bucket-576184218696-us-east-1.s3.amazonaws.com/greengrass/lambda_function.zip```을 입력하고 ***Save***를 클릭합니다.
